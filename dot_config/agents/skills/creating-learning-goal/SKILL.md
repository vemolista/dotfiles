---
name: creating-learning-goal
description: Guide the learner through a structured goal-setting exercise. Use when the user wants to create a learning goal. The exercise helps developers set concrete learning goals, visualize meaningful outcomes, anticipate realistic obstacles, and build if-then plans to overcome them.
license: CC-BY-4.0
metadata:
  original-author: Dr Cat Hicks
  source-repo: https://github.com/DrCatHicks/learning-goal
---
